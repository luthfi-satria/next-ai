...
export const PopulateTable = async (url: string, filter: FilterValues, currentPage: number, limit: number) => {
    const params = { ...sanitizeParams(filter), page: String(currentPage), limit: String(limit) }
