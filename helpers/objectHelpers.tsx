...
export function convertObjectToSelectOptions<T extends object>(
  ...
  return dataArray.map((item) => {
    const value = finalOptions.valueKey && item[finalOptions.valueKey!] !== undefined
      ? String(item[finalOptions.valueKey!])
      : String(finalOptions.defaultValue || '');

    const label = finalOptions.labelKey && item[finalOptions.labelKey!] !== undefined
      ? String(item[finalOptions.labelKey!])
      : String(finalOptions.defaultValue || value);

    const disabled = finalOptions.disabledKey && item[finalOptions.disabledKey!] !== undefined
