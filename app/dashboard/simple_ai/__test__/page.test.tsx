...
describe("summarize feature", () => {
  ...
  test("should have GET METHOD", async () => {
    ...
    expect(jsonResponse.message).toBe(
      "This is the summarize API endpoint. Please use POST.",
    )
  })
  ...
  test("should error if has wrong input parameter", async () => {
    ...
    expect(jsonResponse.error).toBe(
      "Failed to summarize text: invalid parameters",
    )
  })
})
