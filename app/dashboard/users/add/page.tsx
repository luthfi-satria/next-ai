...
import { EnumUserStatus, initUser, NewUser, UserRoles } from "@/models/interfaces/users.interfaces"
...
export default function AddUserPage() {
    ...
    const inputForm = [
        ...
        { type:'password', name: 'password', placeholder: '********', value: newUser?.password || '', onChange: handleInputChange, required: true},
        { type:'password', name: 'repassword', placeholder: '********', value: newUser?.repassword || '', onChange: handleInputChange, required: true},
    ]
        ...
        <>
            ...
            <div className="w-full h-full bg-white rounded-xl shadow-lg p-6 sm:p-8 lg:p-10">
                <div className="flex flex-row gap-2 justify-stretch mb-4 text-gray-800">
                    ...
                    <h2 className="h-full text-xl sm:text-2xl font-bold p-2 flex-grow">Add New User</h2>
                </div>
