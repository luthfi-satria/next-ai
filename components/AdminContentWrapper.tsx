...
export function AdminContentWrapperComponent({ props, children }: { props: ContentProps, children: React.ReactNode }) {
    return (
        <>
            <div className="w-full min-h-screen bg-gray-50 flex flex-col items-center">
                <div className="w-full bg-white rounded-xl shadow-lg p-6 sm:p-8 lg:p-10">
                    <h1 className="text-3xl sm:text-4xl font-extrabold text-gray-900 mb-8">{props.title}</h1>
...
export const translateName = (value: string, rowData: Record<string, any>) => {
    return (
